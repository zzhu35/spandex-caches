...
void llc_spandex_tb::reset_dut(bool is_flush)
{
    bool tmp_rst_tb;
 ...
 */
void llc_spandex_tb::evict_prep(addr_breakdown_llc_t addr_base, addr_breakdown_llc_t &addr1, 
 ...
 */
void llc_spandex_tb::regular_evict_prep(addr_breakdown_llc_t addr_base, addr_breakdown_llc_t &addr1,
...
void llc_spandex_tb::op_rsp(coh_msg_t rsp_msg, addr_breakdown_llc_t req_addr, line_t req_line, cache_id_t req_id)
{
    put_rsp_in(rsp_msg, req_addr.line, req_line, req_id);
}

void llc_spandex_tb::op(mix_msg_t coh_msg, llc_state_t state, bool evict, addr_breakdown_llc_t req_addr, 
...
void llc_spandex_tb::op_dma(mix_msg_t coh_msg, llc_state_t state, bool evict, bool dirty, 
...
void llc_spandex_tb::get_fwd_out(mix_msg_t coh_msg, addr_t addr, cache_id_t req_id, cache_id_t dest_id)
{
...
void llc_spandex_tb::get_mem_req(bool hwrite, addr_t addr, line_t line)
{

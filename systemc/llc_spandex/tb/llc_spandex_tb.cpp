...
void llc_spandex_tb::llc_test()
{
    ...
    ////////////////////////////////////////////////////////////////
    // TEST 1.7: Bulk ReqV - HIT/MISS/NACK
    ////////////////////////////////////////////////////////////////
    ...
    for (int i = 0; i < num_lines; i++) {
      put_req_in(REQ_V /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* line */, 0 /* req_id */,
      DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);

      get_mem_req(LLC_READ /* hwrite */, WORD /* hsize */, DATA /* hprot */, addr.word + (i * 0x10) /* addr */, 0 /* line */);
      ...
      get_rsp_out(RSP_V /* coh_msg */, addr.word + (i * 0x10) /* addr */, line /* line */, 0 /* invack_cnt */,
      0 /* req_id */, 0 /* dest_id */, 0 /* woff */, 0b11 /* word_mask */);
    ...
    /////////////////////////////////////////////////////////////
    // NACK - every other line is owned
    ////////////////////////////////////////////////////////////////
    base_addr = 0x83500000;
    addr.breakdown(base_addr);
    ...
    for (int i = 0; i < num_lines; i+=2) {
      ...
      get_rsp_out(RSP_Odata /* coh_msg */, addr.word + (i * 0x10) /* addr */, line /* line */, 0 /* invack_cnt */,
      0 /* req_id */, 0 /* dest_id */, 0 /* woff */, 0b11 /* word_mask */);
    ...
    /////////////////////////////////////////////////////////////
    // NACK - last line is owned elsewhere and 
    ////////////////////////////////////////////////////////////////
    base_addr = 0x83500200;
    addr.breakdown(base_addr);

    put_req_in(REQ_Odata /* coh_msg */, addr.word + (7 * 0x10) /* addr */, 0 /* line */, 1 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);

    get_mem_req(LLC_READ /* hwrite */, WORD /* hsize */, DATA /* hprot */, addr.word + (7 * 0x10) /* addr */, 0 /* line */);
    ...
    get_rsp_out(RSP_Odata /* coh_msg */, addr.word + (7 * 0x10) /* addr */, line /* line */, 0 /* invack_cnt */,
    1 /* req_id */, 1 /* dest_id */, 0 /* woff */, 0b11 /* word_mask */);
    ...
    // 2nd line 
    get_fwd_out(FWD_RVK_V /* coh_msg */, addr.word + (7 * 0x10) /* addr */, 1 /* req_id */, 1 /* dest_id */, 0 /* line */, 0b11 /* word_mask*/);
    ...
    line.range(BITS_PER_WORD - 1, 0) = 9;
    line.range(BITS_PER_LINE - 1, BITS_PER_WORD) = 8;

    put_rsp_in(RSP_RVK_O /* rsp_msg */, addr.word + (7 * 0x10) /* addr */, line /* line */, 1 /* req_id */, 0b11 /* word_mask */);

    get_rsp_out(RSP_V /* coh_msg */, addr.word + (7 * 0x10) /* addr */, line /* line */, 1 /* invack_cnt */,
    0 /* req_id */, 0 /* dest_id */, 0 /* woff */, 0b11 /* word_mask */);
    ...
    ////////////////////////////////////////////////////////////////
    // TEST 1.8: Bulk ReqWTFwd - MISS/HIT/FWD/CONCURRENT
    ////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////
    // HEAD packet
    put_req_in(REQ_WTfwd /* coh_msg */, addr.word /* addr */, num_lines * WORDS_PER_LINE /* line */, 0 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0 /* word_mask */);
    ...
    for (int i = 0; i < num_lines; i++) {
      ...
      put_req_in(REQ_WTfwd /* coh_msg */, addr.word + (i * 0x10) /* addr */, line /* line */, 0 /* req_id */,
      DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);
    ...
    // TAIL packet
    put_req_in(REQ_WTfwd /* coh_msg */, addr.word /* addr */, 0 /* line */, 0 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0 /* word_mask */);

    get_rsp_out(RSP_O /* coh_msg */, addr.word /* addr */, num_lines * WORDS_PER_LINE /* line */, 0 /* invack_cnt */,
    0 /* req_id */, 0 /* dest_id */, 0 /* woff */, 0 /* word_mask */);

    wait();

    // Read all lines back in a bulk manner
    put_req_in(REQ_V /* coh_msg */, addr.word /* addr */, num_lines * WORDS_PER_LINE /* line */, 0 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);
    ...
    // FWD
    ////////////////////////////////////////////////////////////////
    // Cache 1 owns second half of words
    for (int i = num_lines/2; i < num_lines; i++) {
      put_req_in(REQ_Odata /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* line */, 1 /* req_id */,
      DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);
    ...
    // Cache 0 sends forwards to all words again
    // HEAD packet
    put_req_in(REQ_WTfwd /* coh_msg */, addr.word /* addr */, num_lines * WORDS_PER_LINE /* line */, 0 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0 /* word_mask */);
    ...
    for (int i = 0; i < num_lines; i++) {  
      ...
      if (i == num_lines/2) {
        // Send HEAD and DATA to cache 1
        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 1 /* dest_id */, num_lines * WORDS_PER_LINE /* line */, 0 /* word_mask*/);

        wait();

        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* req_id */, 1 /* dest_id */, line /* line */, 0b11 /* word_mask*/);

        wait();
      } else if (i > num_lines/2) {
        // Send DATA to cache 1
        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* req_id */, 1 /* dest_id */, line /* line */, 0b11 /* word_mask*/);
    ...
    get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 1 /* dest_id */, 0 /* line */, 0 /* word_mask*/);
    ...
    // Cache 2 owns second half of words
    for (int i = num_lines/2; i < num_lines; i++) {
      put_req_in(REQ_Odata /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* line */, 2 /* req_id */,
      DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);

      get_fwd_out(FWD_REQ_Odata /* coh_msg */, addr.word + (i * 0x10) /* addr */, 2 /* req_id */, 1 /* dest_id */, 0 /* line */, 0b11 /* word_mask*/);
    ...
    for (int i = 0; i < num_lines; i++) {  
      ...
      if (i == 0) {
        ...
        // Send TAIL to cache 1, and HEAD and DATA to cache 2
        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 1 /* dest_id */, 0 /* line */, 0 /* word_mask*/);

        wait();

        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 2 /* dest_id */, num_lines * WORDS_PER_LINE /* line */, 0 /* word_mask*/);

        wait();

        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* req_id */, 2 /* dest_id */, line /* line */, 0b11 /* word_mask*/);

        wait();
      } else if (i > num_lines/2) {
        // Send DATA to cache 2
        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (i * 0x10) /* addr */, 0 /* req_id */, 2 /* dest_id */, line /* line */, 0b11 /* word_mask*/);
    ...
    get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 2 /* dest_id */, 0 /* line */, 0 /* word_mask*/);
    ...
    // CONCURRENT: 0->1, 3->2
    ////////////////////////////////////////////////////////////////
    // Cache 0 sends forwards to 1st half words
    // HEAD packet
    put_req_in(REQ_WTfwd /* coh_msg */, addr.word /* addr */, num_lines * WORDS_PER_LINE / 2 /* line */, 0 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0 /* word_mask */);

    wait();

    // Cache 3 sends forwards to 2nd half words
    // HEAD packet
    put_req_in(REQ_WTfwd /* coh_msg */, addr.word + (num_lines / 2 * 0x10) /* addr */, num_lines * WORDS_PER_LINE / 2 /* line */, 3 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0 /* word_mask */);
    ...
    for (int i = 0; i < num_lines / 2; i++) {  
      ...
      if (i == 0) {
        // Send HEAD and DATA to cache 2
        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word /* addr */, 0 /* req_id */, 1 /* dest_id */, num_lines * WORDS_PER_LINE / 2 /* line */, 0 /* word_mask*/);
      ...
      // Cache 3 DATA forward
      word = i+6;
      line.range(BITS_PER_WORD - 1, 0) = word;
      line.range(BITS_PER_LINE - 1, BITS_PER_WORD) = word;

      put_req_in(REQ_WTfwd /* coh_msg */, addr.word + (num_lines / 2 * 0x10) + (i * 0x10) /* addr */, line /* line */, 3 /* req_id */,
      DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0b11 /* word_mask */);
      ...
      if (i == 0) {
        // Send HEAD and DATA to cache 2
        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (num_lines / 2 * 0x10) /* addr */, 3 /* req_id */, 2 /* dest_id */, num_lines * WORDS_PER_LINE / 2 /* line */, 0 /* word_mask*/);

        wait();

        get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (num_lines / 2 * 0x10) + (i * 0x10) /* addr */, 3 /* req_id */, 2 /* dest_id */, line /* line */, 0b11 /* word_mask*/);
    ...
    // TAIL packet
    put_req_in(REQ_WTfwd /* coh_msg */, addr.word + (num_lines / 2 * 0x10) /* addr */, 0 /* line */, 3 /* req_id */,
    DATA /* hprot */, 0 /* woff */, 0 /* wvalid */, 0 /* word_mask */);

    get_fwd_out(FWD_WTfwd_BULK /* coh_msg */, addr.word + (num_lines / 2 * 0x10) /* addr */, 3 /* req_id */, 2 /* dest_id */, 0 /* line */, 0 /* word_mask*/);

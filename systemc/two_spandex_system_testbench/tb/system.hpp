...
public:
    ...
    // Modules
    // L2 cache instance
    l2_spandex_wrapper	*l2_dut;
	// LLC cache instance
	llc_spandex_wrapper *llc_dut;
    // L2 testbench module
    l2_spandex_tb      	*tb;
    ...
    {
    	// Modules
    	l2_dut = new l2_spandex_wrapper("l2_spandex_wrapper");
    	llc_dut = new llc_spandex_wrapper("llc_spandex_wrapper");
